...
defmodule Soroban.RPC.CannedInvokeContractFunctionClientImpl do
  ...
  def request(
        ...
        %{
          transaction:
            ""
        },
        _opts
      ) do
    send(self(), {:request, "RESPONSE"})
  ...
  def request(
        ...
        %{
          transaction:
            ""
        },
        _opts
      ) do
    send(self(), {:request, "RESPONSE"})
  ...
  def request(
        ...
        %{
          transaction:
            ""
        },
        _opts
      ) do
    send(self(), {:request, "RESPONSE"})
  ...
  def request(
        ...
        %{
          transaction:
            ""
        },
        _opts
      ) do
    send(self(), {:request, "RESPONSE"})
    ...
    {:ok,
     %{
       ...
       results: [
         %{
           auth: [
             "AAAAAAAAAAAAAAABCYz5KO4roQUbbGNGg0NhIp4paZo/6w8hnbP6sebHkjQAAAADaW5jAAAAAAIAAAASAAAAAAAAAADJTnjlYcJxSKDat78jbEyDkVqo2uhpNX4BdBtqGrx+1gAAAAkAAAAAAAAAAAAAAAAAAAACAAAAAA=="
           ],
  ...
  def request(
        ...
        %{
          transaction:
            ""
        },
        _opts
      ) do
    send(self(), {:request, "RESPONSE"})
