    ...
    %{
      ...
      wasm:
        <<0, 97, 115, 109, 1, 0, 0, 0, 1, 22, 4, 96, 2, 126, 126, 1, 126, 96, 4, 126, 126, 126,
          ...
          0, 1>>,
      envelope_xdr:
        ""
    }
  end
